//! RustaSea Storage — read-through disk storage with confined paths.
//!
...
pub use crate::facade::{
    AzureDiskConfig, DiskDefinition, DiskSettings, GcsDiskConfig, LocalDiskConfig, S3DiskConfig,
    StorageFacadeConfig, Visibility,
};
